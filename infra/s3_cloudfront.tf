# =============================================================================
# S3 + CloudFront — Static frontend with versioning & lifecycle (~$2/mo)
# =============================================================================
...
# Versioning — track all changes to deployed files
...
# Lifecycle — clean up old versions after 30 days
...
# OAC — CloudFront exclusively accesses S3
