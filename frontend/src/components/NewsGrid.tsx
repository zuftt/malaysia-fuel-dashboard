  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 panel">
        {articles.length === 0 ? (
          <div className="col-span-full px-6 py-10 text-center text-[#4b4b48]">
            ...
            <p className="text-[12px] opacity-80">Check that the backend can reach the internet for Google News RSS.</p>
          </div>
        ) : (
      ...
      <Disclaimer title="About these headlines" tone="neutral">
        <p>
          Headlines are pulled from Google News RSS. RONradar does not edit, endorse, or verify the content of linked
